        ...
        for user_dir in dirs:
    	    if user_dir != "ubuntu":
                ...
                if not os.path.exists(src_dir):
                    ...
                    the_cmd=  os.path.join(work_dir,"src/timeout.sh --detect-hangups -p '.*main.out.*,TOIMAIN.OUT' ")+constrain+ out_path + " " + in_file_path + " " + ms_file_path + "> %s 2>&1"%(out_log_file)
